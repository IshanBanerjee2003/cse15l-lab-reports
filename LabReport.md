...
@@ -18,13 +19,16 @@ Next is to  obtain a course-specific account for CSE15L from
...
@@ -33,16 +37,21 @@ One of the basic requirements would be that of copying files back and forth betw
...
@@ -51,9 +60,11 @@ The scp command may be used for this purpose.
